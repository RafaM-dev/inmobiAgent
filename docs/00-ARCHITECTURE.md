...
| **F9 — Producción** 🔶 | **Hecho:** control de coste por inmobiliaria (contador transaccional, tope mensual, degradación a persona, visible y editable en el panel). **Pendiente:** rate limiting por tenant, OpenTelemetry, RLS, backups, dashboards, evaluación automática de calidad. | SLOs definidos y medidos; runbook de incidentes. |
